...
const JobPost = ({ job }: Props) => {
	...
	return (
		<article className='rounded-lg bg-[#fff] shadow-custom'>
			<div className='flex w-full gap-7 pl-4 pt-6 pb-5 pr-3 md:gap-3 xs:px-1'>
				<div className='relative h-[85px] w-[85px] overflow-hidden rounded-full md:min-h-[66px] md:min-w-[66px] md:self-center '>
